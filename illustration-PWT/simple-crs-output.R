...
outfile=paste("./Data/pwt-simple-result-95CI",np,"q",nq,".csv",sep="")
write.csv(res0,row.names=FALSE,file=outfile)

outfile=paste("./Data/pwt-simple-result-sharpening-p-95CI",np,"q",nq,".csv",sep="")
...
setEPS()
postscript(file = "./Figures/pwt-sigma-simple-100kappa.eps",width=10, height=8)
...
postscript(file = "./Figures/pwt-CI-simple-100kappa.eps",width=10, height=8)
...
setEPS()
postscript(file = "./Figures/pwt-meanbias-simple-100kappa.eps",width=10, height=8)
